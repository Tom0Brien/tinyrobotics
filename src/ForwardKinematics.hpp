...
namespace RML {
     ...
     */
    template <typename Scalar>
    Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic> Jv(std::shared_ptr<Model<Scalar>> model,
        ...
        Eigen::MatrixXd Jv = jacobian(position<autodiff::real>,
                                      wrt(q_real),
     ...
     */
    template <typename Scalar>
    Eigen::Matrix<Scalar, 6, Eigen::Dynamic> geometric_jacobian(std::shared_ptr<Model<Scalar>> model,
                                                                Eigen::Matrix<Scalar, Eigen::Dynamic, 1>& q,
                                                                std::string& target_link_name) {
